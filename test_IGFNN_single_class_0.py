...
def test2(fname, loader_test, device, p):
    ...
    ig = pickle.load(open("ig_single_class.pkl", "rb"))
    ...
    accuracy1 = float(num_correct) / num_samples * 100
    acc_vec_1 = acc_per_class_N_correct / acc_per_class_N
    # print('\nAccuracy = %.2f%%' % accuracy1)
