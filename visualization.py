...
def linear_transform(attributions, clip_above_percentile=99.9, clip_below_percentile=70.0, low=0.2, plot_distribution=False, force_m_e=False, m=0, e=1):
    if force_m_e == False:
...
def visualize(attributions, image, positive_channel=G, negative_channel=R, polarity='positive', \
                ...
                mask_mode=False, plot_distribution=False, channel=[255, 0, 0], force_m_e=False, m=0, e=1):
    if polarity == 'both':
        raise NotImplementedError
    ...
    attributions, m, e = linear_transform(attributions, clip_above_percentile, clip_below_percentile, 0.0, plot_distribution=plot_distribution, force_m_e=force_m_e, m=m, e=e)
